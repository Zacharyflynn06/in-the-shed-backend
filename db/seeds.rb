...
#User
User.create(username: "zacharyflynn06")
...
# Songs
Song.create(title: "Stir It Up", author: "Bob Marley", tempo: 100, user_id: 2)


Song.first.time_signature = TimeSignature.first

Measure.create(song_id: 1)
Measure.create(song_id: 1)
Measure.create(song_id: 1)
Measure.create(song_id: 1)

Chord.create(name: "A", root: "A", quality: "maj")
Chord.create(name: "D", root: "D", quality: "maj")
Chord.create(name: "E", root: "E", quality: "maj")

Measure.find(1).chords << Chord.first
Measure.find(2).chords << Chord.first
Measure.find(3).chords << Chord.find(2)
Measure.find(4).chords << Chord.find(3)
